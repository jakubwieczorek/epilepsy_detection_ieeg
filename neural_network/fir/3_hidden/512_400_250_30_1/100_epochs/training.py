...
class FeedForward:
    ...
    def createModel(self):
        self.model = keras.Sequential([ # layers in sequence
                keras.layers.Dense(512, activation="relu"), # Dense means fully connected
                keras.layers.Dense(400, activation="relu"), # Dense means fully connected
                keras.layers.Dense(250, activation="relu"), # Dense means fully connected
                keras.layers.Dense(30, activation="relu"), # Dense means fully connected

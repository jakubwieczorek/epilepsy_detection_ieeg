...
class CNN:
    ...
    def __init__(self):
        ### train parsing
        data_dirs = ["../dataset/ID08/64/train_data18/",
                       "../dataset/ID08/64/test_data19/",
        ...
        for i in range(0, len(data_files)):
            data.append(parse_csv(data_files[i], 64))
        ...
        self.data = tf.reshape(np.array(self.data), (-1, 64, CNN.sensor_num)).numpy()
    ...
    def createModel(self):
        ...
        self.model = keras.Sequential([  # layers in sequence
            keras.layers.Conv1D(100, 9, activation="relu", input_shape=(64, CNN.sensor_num)),

...
class CNN:
    ...
    def __init__(self):
        ...
        val_dir = "../dataset/ID08/64/test_data19/"
        ...
        for i in range(0, len(val_files)):
            val_data.append(parse_csv(val_dir + val_files[i], 64))
        ...
        self.val_data = tf.reshape(self.val_data, (-1, 64, CNN.sensor_num)).numpy()
    ...
    def createModel(self):
        ...
        self.model = keras.Sequential([  # layers in sequence
            keras.layers.Conv1D(60, 3, input_shape=(64, CNN.sensor_num)),

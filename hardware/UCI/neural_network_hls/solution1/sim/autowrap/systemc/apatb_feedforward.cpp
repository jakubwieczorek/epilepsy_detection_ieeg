...
// wrapc file define:
#define AUTOTB_TVIN_x "../tv/cdatafile/c.feedforward.autotvin_x.dat"
#define AUTOTB_TVOUT_x "../tv/cdatafile/c.feedforward.autotvout_x.dat"
// wrapc file define:
#define AUTOTB_TVIN_y "../tv/cdatafile/c.feedforward.autotvin_y.dat"
#define AUTOTB_TVOUT_y "../tv/cdatafile/c.feedforward.autotvout_y.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_x "../tv/rtldatafile/rtl.feedforward.autotvout_x.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_y "../tv/rtldatafile/rtl.feedforward.autotvout_y.dat"
...
extern "C" void feedforward_hw_stub_wrapper(volatile void *, volatile void *);
    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > y_pc_buffer(2);
          int i = 0;
          ...
          if (i > 0) {{
            ...
            ((int*)__xlx_apatb_param_y)[j] = y_pc_buffer[i].to_int64();
          }}}
        } // end transaction
      } // end file is good
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_x)[j];
  ...
  tcl_file.set_num(178, &tcl_file.x_depth);
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_y)[j];
  ...
  tcl_file.set_num(2, &tcl_file.y_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_y, __xlx_sprintf_buffer.data());
}
CodeState = CALL_C_DUT;
feedforward_hw_stub_wrapper(__xlx_apatb_param_x, __xlx_apatb_param_y);

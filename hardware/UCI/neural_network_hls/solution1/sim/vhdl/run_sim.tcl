...
if {[file isfile feedforward.autotvin.dat]} {
	file delete -force feedforward.autotvin.dat
}

if {[file isfile feedforward.autotvout.dat]} {
	file delete -force feedforward.autotvout.dat
}

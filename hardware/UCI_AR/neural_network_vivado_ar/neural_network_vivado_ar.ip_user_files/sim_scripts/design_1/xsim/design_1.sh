...
xv_boost_lib_path=/home/jakub/apps/Xilinx/Vivado/2020.2/tps/boost_1_64_0
...
{
  file="xsim.ini"
  lib_map_path="/home/jakub/apps/Xilinx/Vivado/2020.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
